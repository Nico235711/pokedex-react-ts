    ...
    <>
      ...
      <main className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-5">
          ...
          <button
            type="button"
            className={`${darkMode ? 'bg-gray-800 via-gray-900 to-black' : 'from-pink-500 to-violet-500'} col-span-1 md:col-span-2 lg:col-span-3 text-white bg-gradient-to-r  p-5 rounded-md shadow-md hover:from-pink-600 hover:to-violet-600 transition-all`}
